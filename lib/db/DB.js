...
class DB {
  ...
  define() {
    ...
    this.Peer = this.sequelize.define('peers', {
    ...
    this.Currency = this.sequelize.define('currencies', {
      id: { type: DataTypes.STRING, primaryKey: true },
    });

    //

    this.Pair = this.sequelize.define('pairs', {
      id: { type: DataTypes.STRING, primaryKey: true },
    ...
    this.Order = this.sequelize.define('orders', {
      id: { type: DataTypes.INTEGER, primaryKey: true, autoIncrement: true },
      pairId: { type: DataTypes.STRING, allowNull: false },
      makerPeerId: { type: DataTypes.INTEGER, allowNull: true },
      side: {
        type: DataTypes.ENUM, values: Object.values(enums.orderSides), allowNull: true,
      },
