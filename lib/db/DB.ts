      ...
      await Node.bulkCreate(<db.NodeAttributes[]>[
        {
          ...
          lastAddress: { host: 'xud1.test.exchangeunion.com', port: 8885 },
        },
        {
          ...
          lastAddress: { host: 'xud2.test.exchangeunion.com', port: 8885 },
        },
        {
          ...
          lastAddress: { host: 'xud3.test.exchangeunion.com', port: 8885 },
        },
      ]);
