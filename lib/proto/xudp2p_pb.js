...
proto.xudp2p.NodeState.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    connextAddress: jspb.Message.getFieldWithDefault(msg, 9, "")
  };
...
/**
 * optional string connext_address = 9;
 * @return {string}
 */
proto.xudp2p.NodeState.prototype.getConnextAddress = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 9, ""));
};


/** @param {string} value */
proto.xudp2p.NodeState.prototype.setConnextAddress = function(value) {
