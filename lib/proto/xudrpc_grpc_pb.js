...
function serialize_xudrpc_EmptyRequest(arg) {
  if (!(arg instanceof xudrpc_pb.EmptyRequest)) {
    throw new Error('Expected argument of type xudrpc.EmptyRequest');
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_xudrpc_EmptyRequest(buffer_arg) {
  return xudrpc_pb.EmptyRequest.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var XudService = exports.XudService = {
  ...
  subscribePeerOrders: {
    ...
    requestStream: false,
    responseStream: false,
    requestType: xudrpc_pb.EmptyRequest,
    responseType: xudrpc_pb.SubscribePeerOrdersResponse,
    requestSerialize: serialize_xudrpc_EmptyRequest,
    requestDeserialize: deserialize_xudrpc_EmptyRequest,
