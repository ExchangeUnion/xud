...
function serialize_xudrpc_SubscibeInvoicesRequest(arg) {
  if (!(arg instanceof xudrpc_pb.SubscibeInvoicesRequest)) {
    throw new Error('Expected argument of type xudrpc.SubscibeInvoicesRequest');
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_xudrpc_SubscibeInvoicesRequest(buffer_arg) {
  return xudrpc_pb.SubscibeInvoicesRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_xudrpc_SubscibeInvoicesResponse(arg) {
  if (!(arg instanceof xudrpc_pb.SubscibeInvoicesResponse)) {
    throw new Error('Expected argument of type xudrpc.SubscibeInvoicesResponse');
  }
  return new Buffer(arg.serializeBinary());
}

function deserialize_xudrpc_SubscibeInvoicesResponse(buffer_arg) {
  return xudrpc_pb.SubscibeInvoicesResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
...
var XudService = exports.XudService = {
  ...
  subscribeInvoices: {
    ...
    requestStream: false,
    responseStream: true,
    requestType: xudrpc_pb.SubscibeInvoicesRequest,
    responseType: xudrpc_pb.SubscibeInvoicesResponse,
    requestSerialize: serialize_xudrpc_SubscibeInvoicesRequest,
    requestDeserialize: deserialize_xudrpc_SubscibeInvoicesRequest,
    responseSerialize: serialize_xudrpc_SubscibeInvoicesResponse,
    responseDeserialize: deserialize_xudrpc_SubscibeInvoicesResponse,
  },
