...
/**
 * optional LndInfo lndltc = 6;
 * @return {?proto.xudrpc.LndInfo}
 */
proto.xudrpc.GetInfoResponse.prototype.getLndltc = function() {
  return /** @type{?proto.xudrpc.LndInfo} */ (
    jspb.Message.getWrapperField(this, proto.xudrpc.LndInfo, 6));
};
...
proto.xudrpc.GetInfoResponse.prototype.getRaiden = function() {
  return /** @type{?proto.xudrpc.RaidenInfo} */ (
    jspb.Message.getWrapperField(this, proto.xudrpc.RaidenInfo, 7));
};
