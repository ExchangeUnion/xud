...
goog.exportSymbol('proto.xudrpc.ListSwapsRequest.RequestedSwapState', null, global);
...
proto.xudrpc.ListSwapsRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    limit: jspb.Message.getFieldWithDefault(msg, 1, 0),
    requestedSwapState: jspb.Message.getFieldWithDefault(msg, 2, 0)
  };
...
proto.xudrpc.ListSwapsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.xudrpc.ListSwapsRequest.RequestedSwapState} */ (reader.readEnum());
      msg.setRequestedSwapState(value);
      break;
    default:
      reader.skipField();
      break;
...
proto.xudrpc.ListSwapsRequest.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getRequestedSwapState();
  if (f !== 0.0) {
    writer.writeEnum(
      2,
      f
 ...
 * @enum {number}
 */
proto.xudrpc.ListSwapsRequest.RequestedSwapState = {
  ALL: 0,
  SUCCESSFUL: 1,
  FAILED: 2
};
...
/**
 * optional RequestedSwapState requested_swap_state = 2;
 * @return {!proto.xudrpc.ListSwapsRequest.RequestedSwapState}
 */
proto.xudrpc.ListSwapsRequest.prototype.getRequestedSwapState = function() {
  return /** @type {!proto.xudrpc.ListSwapsRequest.RequestedSwapState} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {!proto.xudrpc.ListSwapsRequest.RequestedSwapState} value */
proto.xudrpc.ListSwapsRequest.prototype.setRequestedSwapState = function(value) {
  jspb.Message.setField(this, 2, value);
};
 ...
 * @const
 */
proto.xudrpc.Swap.oneofGroups_ = [[2,3]];
