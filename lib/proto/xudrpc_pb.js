...
goog.exportSymbol('proto.xudrpc.LndInfo.LndInfoStatus', null, global);
...
proto.xudrpc.LndInfo.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = /** @type {!proto.xudrpc.LndInfo.LndInfoStatus} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    case 2:
      var value = /** @type {string} */ (reader.readString());
 ...
 * @enum {number}
 */
proto.xudrpc.LndInfo.LndInfoStatus = {
  READY: 0,
  ERROR: 1
};

/**
 * optional LndInfoStatus status = 1;
 * @return {!proto.xudrpc.LndInfo.LndInfoStatus}
 */
proto.xudrpc.LndInfo.prototype.getStatus = function() {
  return /** @type {!proto.xudrpc.LndInfo.LndInfoStatus} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {!proto.xudrpc.LndInfo.LndInfoStatus} value */
