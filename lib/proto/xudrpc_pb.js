...
proto.xudrpc.RemoveAllOrdersResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    erroredOrderIdsMap: (f = msg.getErroredOrderIdsMap()) ? f.toObject(includeInstance, undefined) : []
  };
...
proto.xudrpc.RemoveAllOrdersResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = msg.getErroredOrderIdsMap();
      reader.readMessage(value, function(message, reader) {
        jspb.Map.deserializeBinary(message, reader, jspb.BinaryReader.prototype.readString, jspb.BinaryReader.prototype.readString, null, "");
         });
      break;
...
proto.xudrpc.RemoveAllOrdersResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getErroredOrderIdsMap(true);
  if (f && f.getLength() > 0) {
    f.serializeBinary(3, writer, jspb.BinaryWriter.prototype.writeString, jspb.BinaryWriter.prototype.writeString);
  }
};
...
/**
 * map<string, string> errored_order_ids = 3;
 * @param {boolean=} opt_noLazyCreate Do not create the map if
 * empty, instead returning `undefined`
 * @return {!jspb.Map<string,string>}
 */
proto.xudrpc.RemoveAllOrdersResponse.prototype.getErroredOrderIdsMap = function(opt_noLazyCreate) {
  return /** @type {!jspb.Map<string,string>} */ (
      jspb.Message.getMapField(this, 3, opt_noLazyCreate,
      null));
};
...
proto.xudrpc.RemoveAllOrdersResponse.prototype.clearErroredOrderIdsMap = function() {
  this.getErroredOrderIdsMap().clear();
};
