...
proto.xudrpc.ConnectRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    retryConnecting: jspb.Message.getFieldWithDefault(msg, 2, false)
  };
...
/**
 * optional bool retry_connecting = 2;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.xudrpc.ConnectRequest.prototype.getRetryConnecting = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 2, false));
};


/** @param {boolean} value */
proto.xudrpc.ConnectRequest.prototype.setRetryConnecting = function(value) {
  jspb.Message.setField(this, 2, value);
};
