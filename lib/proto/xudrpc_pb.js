...
goog.exportSymbol('proto.xudrpc.ListSwapsRequest.Status', null, global);
...
proto.xudrpc.ListSwapsRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 1:
      ...
      break;
    case 3:
      var value = /** @type {!proto.xudrpc.ListSwapsRequest.Status} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    default:
      reader.skipField();
 ...
 * @enum {number}
 */
proto.xudrpc.ListSwapsRequest.Status = {
  BOTH: 0,
  SUCCESSFUL: 1,
  FAILED: 2
};
 ...
 * @return {!proto.xudrpc.ListSwapsRequest.Status}
 */
proto.xudrpc.ListSwapsRequest.prototype.getStatus = function() {
  return /** @type {!proto.xudrpc.ListSwapsRequest.Status} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/** @param {!proto.xudrpc.ListSwapsRequest.Status} value */
proto.xudrpc.ListSwapsRequest.prototype.setStatus = function(value) {
  jspb.Message.setField(this, 3, value);
};
