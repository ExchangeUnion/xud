...
proto.xudrpc.SwapSuccess.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    currencyReceived: jspb.Message.getFieldWithDefault(msg, 9, ""),
    currencySent: jspb.Message.getFieldWithDefault(msg, 10, ""),
    pairId: jspb.Message.getFieldWithDefault(msg, 11, "")
  };
...
proto.xudrpc.SwapSuccess.prototype.getRole = function() {
  return /** @type {!proto.xudrpc.SwapSuccess.Role} */ (jspb.Message.getFieldWithDefault(this, 8, 0));
};
...
/**
 * optional string currency_received = 9;
 * @return {string}
 */
...
/**
 * optional string currency_sent = 10;
 * @return {string}
 */
