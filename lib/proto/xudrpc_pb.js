...
goog.exportSymbol('proto.xudrpc.OrderType', null, global);
...
proto.xudrpc.PlaceOrderRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 5:
      ...
      break;
    case 6:
      var value = /** @type {!proto.xudrpc.OrderType} */ (reader.readEnum());
      msg.setType(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!proto.xudrpc.OrderType}
 */
proto.xudrpc.PlaceOrderRequest.prototype.getType = function() {
  return /** @type {!proto.xudrpc.OrderType} */ (jspb.Message.getFieldWithDefault(this, 6, 0));
};


/** @param {!proto.xudrpc.OrderType} value */
proto.xudrpc.PlaceOrderRequest.prototype.setType = function(value) {
  jspb.Message.setField(this, 6, value);
};
