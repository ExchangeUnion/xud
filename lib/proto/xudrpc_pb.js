...
goog.exportSymbol('proto.xudrpc.ChannelBalanceAlert', null, global);
goog.exportSymbol('proto.xudrpc.ChannelBalanceAlert.Side', null, global);
 ...
 * @const
 */
proto.xudrpc.Alert.oneofGroups_ = [[3,4]];
...
proto.xudrpc.Alert.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    channelBalanceAlert: (f = msg.getChannelBalanceAlert()) && proto.xudrpc.ChannelBalanceAlert.toObject(includeInstance, f),
...
proto.xudrpc.Alert.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    case 2:
      ...
      break;
    case 3:
      var value = new proto.xudrpc.ChannelBalanceAlert;
      reader.readMessage(value,proto.xudrpc.ChannelBalanceAlert.deserializeBinaryFromReader);
      msg.setChannelBalanceAlert(value);
      break;
    case 4:
...
proto.xudrpc.Alert.serializeBinaryToWriter = function(message, writer) {
  ...
  f = message.getChannelBalanceAlert();
  if (f != null) {
    writer.writeMessage(
      3,
      f,
      proto.xudrpc.ChannelBalanceAlert.serializeBinaryToWriter
    );
  }
...
/**
 * optional ChannelBalanceAlert channel_balance_alert = 3;
 * @return {?proto.xudrpc.ChannelBalanceAlert}
 */
proto.xudrpc.Alert.prototype.getChannelBalanceAlert = function() {
  return /** @type{?proto.xudrpc.ChannelBalanceAlert} */ (
    jspb.Message.getWrapperField(this, proto.xudrpc.ChannelBalanceAlert, 3));
};


/** @param {?proto.xudrpc.ChannelBalanceAlert|undefined} value */
proto.xudrpc.Alert.prototype.setChannelBalanceAlert = function(value) {
  jspb.Message.setOneofWrapperField(this, 3, proto.xudrpc.Alert.oneofGroups_[0], value);
};


proto.xudrpc.Alert.prototype.clearChannelBalanceAlert = function() {
  this.setChannelBalanceAlert(undefined);
};
 ...
 * @return {boolean}
 */
proto.xudrpc.Alert.prototype.hasChannelBalanceAlert = function() {
...
proto.xudrpc.Alert.prototype.setBalanceAlert = function(value) {
  jspb.Message.setOneofWrapperField(this, 4, proto.xudrpc.Alert.oneofGroups_[0], value);
};
 ...
 * @constructor
 */
proto.xudrpc.ChannelBalanceAlert = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.xudrpc.ChannelBalanceAlert, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.xudrpc.ChannelBalanceAlert.displayName = 'proto.xudrpc.ChannelBalanceAlert';
}
 ...
 * @return {!Object}
 */
proto.xudrpc.ChannelBalanceAlert.prototype.toObject = function(opt_includeInstance) {
  return proto.xudrpc.ChannelBalanceAlert.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.xudrpc.ChannelBalanceAlert} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.xudrpc.ChannelBalanceAlert.toObject = function(includeInstance, msg) {
  var f, obj = {
    totalBalance: jspb.Message.getFieldWithDefault(msg, 1, 0),
    side: jspb.Message.getFieldWithDefault(msg, 2, 0),
    bound: jspb.Message.getFieldWithDefault(msg, 3, 0),
    sideBalance: jspb.Message.getFieldWithDefault(msg, 4, 0),
    channelPoint: jspb.Message.getFieldWithDefault(msg, 5, ""),
 ...
 * @return {!proto.xudrpc.ChannelBalanceAlert}
 */
proto.xudrpc.ChannelBalanceAlert.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.xudrpc.ChannelBalanceAlert;
  return proto.xudrpc.ChannelBalanceAlert.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.xudrpc.ChannelBalanceAlert} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.xudrpc.ChannelBalanceAlert}
 */
proto.xudrpc.ChannelBalanceAlert.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 1:
      ...
      break;
    case 2:
      var value = /** @type {!proto.xudrpc.ChannelBalanceAlert.Side} */ (reader.readEnum());
      msg.setSide(value);
      break;
    case 3:
      var value = /** @type {number} */ (reader.readUint32());
 ...
 * @return {!Uint8Array}
 */
proto.xudrpc.ChannelBalanceAlert.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.xudrpc.ChannelBalanceAlert.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.xudrpc.ChannelBalanceAlert} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.xudrpc.ChannelBalanceAlert.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getTotalBalance();
  if (f !== 0) {
    writer.writeUint64(
 ...
 * @enum {number}
 */
proto.xudrpc.ChannelBalanceAlert.Side = {
  REMOTE: 0,
  LOCAL: 1
};
 ...
 * @return {number}
 */
proto.xudrpc.ChannelBalanceAlert.prototype.getTotalBalance = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 1, 0));
};


/** @param {number} value */
proto.xudrpc.ChannelBalanceAlert.prototype.setTotalBalance = function(value) {
  jspb.Message.setProto3IntField(this, 1, value);
};
...
/**
 * optional Side side = 2;
 * @return {!proto.xudrpc.ChannelBalanceAlert.Side}
 */
proto.xudrpc.ChannelBalanceAlert.prototype.getSide = function() {
  return /** @type {!proto.xudrpc.ChannelBalanceAlert.Side} */ (jspb.Message.getFieldWithDefault(this, 2, 0));
};


/** @param {!proto.xudrpc.ChannelBalanceAlert.Side} value */
proto.xudrpc.ChannelBalanceAlert.prototype.setSide = function(value) {
  jspb.Message.setProto3EnumField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.xudrpc.ChannelBalanceAlert.prototype.getBound = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/** @param {number} value */
proto.xudrpc.ChannelBalanceAlert.prototype.setBound = function(value) {
  jspb.Message.setProto3IntField(this, 3, value);
};
 ...
 * @return {number}
 */
proto.xudrpc.ChannelBalanceAlert.prototype.getSideBalance = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};


/** @param {number} value */
proto.xudrpc.ChannelBalanceAlert.prototype.setSideBalance = function(value) {
  jspb.Message.setProto3IntField(this, 4, value);
};


/**
 * optional string channel_point = 5;
 * @return {string}
 */
proto.xudrpc.ChannelBalanceAlert.prototype.getChannelPoint = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};


/** @param {string} value */
proto.xudrpc.ChannelBalanceAlert.prototype.setChannelPoint = function(value) {
  jspb.Message.setProto3StringField(this, 5, value);
};
 ...
 * @return {string}
 */
proto.xudrpc.ChannelBalanceAlert.prototype.getCurrency = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 6, ""));
};


/** @param {string} value */
proto.xudrpc.ChannelBalanceAlert.prototype.setCurrency = function(value) {
