...
proto.xudrpc.Balance.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    noChannels: jspb.Message.getFieldWithDefault(msg, 7, false)
  };
...
/**
 * optional bool no_channels = 7;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.xudrpc.Balance.prototype.getNoChannels = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 7, false));
};


/** @param {boolean} value */
proto.xudrpc.Balance.prototype.setNoChannels = function(value) {
