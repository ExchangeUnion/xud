...
goog.exportSymbol('proto.xudrpc.SubscribeExistingRequest', null, global);
 ...
 * @constructor
 */
proto.xudrpc.SubscribeExistingRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.xudrpc.SubscribeExistingRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.xudrpc.SubscribeExistingRequest.displayName = 'proto.xudrpc.SubscribeExistingRequest';
}
 ...
 * @return {!Object}
 */
proto.xudrpc.SubscribeExistingRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.xudrpc.SubscribeExistingRequest.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.xudrpc.SubscribeExistingRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.xudrpc.SubscribeExistingRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    showExisting: jspb.Message.getFieldWithDefault(msg, 1, false)
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.xudrpc.SubscribeExistingRequest}
 */
proto.xudrpc.SubscribeExistingRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.xudrpc.SubscribeExistingRequest;
  return proto.xudrpc.SubscribeExistingRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.xudrpc.SubscribeExistingRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.xudrpc.SubscribeExistingRequest}
 */
proto.xudrpc.SubscribeExistingRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.xudrpc.SubscribeExistingRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.xudrpc.SubscribeExistingRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.xudrpc.SubscribeExistingRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.xudrpc.SubscribeExistingRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getShowExisting();
  if (f) {
    writer.writeBool(
      1,
      f
...
/**
 * optional bool show_existing = 1;
 * Note that Boolean fields may be set to 0/1 when serialized from a Java server.
 * You should avoid comparisons like {@code val === true/false} in those cases.
 * @return {boolean}
 */
proto.xudrpc.SubscribeExistingRequest.prototype.getShowExisting = function() {
  return /** @type {boolean} */ (jspb.Message.getFieldWithDefault(this, 1, false));
};


/** @param {boolean} value */
proto.xudrpc.SubscribeExistingRequest.prototype.setShowExisting = function(value) {
  jspb.Message.setField(this, 1, value);
};
