...
goog.exportSymbol('proto.xudrpc.ListOrderHistoryRequest', null, global);
goog.exportSymbol('proto.xudrpc.ListOrderHistoryResponse', null, global);
goog.exportSymbol('proto.xudrpc.ListOrderHistoryResponse.OrderStatus', null, global);
 ...
 * @constructor
 */
proto.xudrpc.ListOrderHistoryRequest = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.xudrpc.ListOrderHistoryRequest, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.xudrpc.ListOrderHistoryRequest.displayName = 'proto.xudrpc.ListOrderHistoryRequest';
}
 ...
 * @return {!Object}
 */
proto.xudrpc.ListOrderHistoryRequest.prototype.toObject = function(opt_includeInstance) {
  return proto.xudrpc.ListOrderHistoryRequest.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.xudrpc.ListOrderHistoryRequest} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.xudrpc.ListOrderHistoryRequest.toObject = function(includeInstance, msg) {
  var f, obj = {
    orderId: jspb.Message.getFieldWithDefault(msg, 1, "")
  };
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.xudrpc.ListOrderHistoryRequest}
 */
proto.xudrpc.ListOrderHistoryRequest.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.xudrpc.ListOrderHistoryRequest;
  return proto.xudrpc.ListOrderHistoryRequest.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.xudrpc.ListOrderHistoryRequest} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.xudrpc.ListOrderHistoryRequest}
 */
proto.xudrpc.ListOrderHistoryRequest.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
 ...
 * @return {!Uint8Array}
 */
proto.xudrpc.ListOrderHistoryRequest.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.xudrpc.ListOrderHistoryRequest.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.xudrpc.ListOrderHistoryRequest} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.xudrpc.ListOrderHistoryRequest.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getOrderId();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.xudrpc.ListOrderHistoryRequest.prototype.getOrderId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.xudrpc.ListOrderHistoryRequest.prototype.setOrderId = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 * @constructor
 */
proto.xudrpc.ListOrderHistoryResponse = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, proto.xudrpc.ListOrderHistoryResponse.repeatedFields_, null);
};
goog.inherits(proto.xudrpc.ListOrderHistoryResponse, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.xudrpc.ListOrderHistoryResponse.displayName = 'proto.xudrpc.ListOrderHistoryResponse';
}
/**
 * List of repeated fields within this message type.
 * @private {!Array<number>}
 * @const
 */
proto.xudrpc.ListOrderHistoryResponse.repeatedFields_ = [1,2];
 ...
 * @return {!Object}
 */
proto.xudrpc.ListOrderHistoryResponse.prototype.toObject = function(opt_includeInstance) {
  return proto.xudrpc.ListOrderHistoryResponse.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.xudrpc.ListOrderHistoryResponse} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.xudrpc.ListOrderHistoryResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
 ...
 * Deserializes binary data (in protobuf wire format).
 * @param {jspb.ByteSource} bytes The bytes to deserialize.
 * @return {!proto.xudrpc.ListOrderHistoryResponse}
 */
proto.xudrpc.ListOrderHistoryResponse.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.xudrpc.ListOrderHistoryResponse;
  return proto.xudrpc.ListOrderHistoryResponse.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.xudrpc.ListOrderHistoryResponse} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.xudrpc.ListOrderHistoryResponse}
 */
proto.xudrpc.ListOrderHistoryResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 2:
      ...
      break;
    case 3:
      var value = /** @type {!proto.xudrpc.ListOrderHistoryResponse.OrderStatus} */ (reader.readEnum());
      msg.setStatus(value);
      break;
    default:
      reader.skipField();
 ...
 * @return {!Uint8Array}
 */
proto.xudrpc.ListOrderHistoryResponse.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.xudrpc.ListOrderHistoryResponse.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.xudrpc.ListOrderHistoryResponse} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.xudrpc.ListOrderHistoryResponse.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
 ...
 * @enum {number}
 */
proto.xudrpc.ListOrderHistoryResponse.OrderStatus = {
  FILLED: 0,
  PARTIALLY_FILLED: 1,
  OPEN: 2,
  CANCELLED: 3
 ...
 */
proto.xudrpc.ListOrderHistoryResponse.prototype.getTradesList = function() {
...
proto.xudrpc.ListOrderHistoryResponse.prototype.setTradesList = function(value) {
  jspb.Message.setRepeatedWrapperField(this, 1, value);
};
 ...
 */
proto.xudrpc.ListOrderHistoryResponse.prototype.addTrades = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.xudrpc.Trade, opt_index);
};


proto.xudrpc.ListOrderHistoryResponse.prototype.clearTradesList = function() {
  this.setTradesList([]);
};


/**
 * repeated SwapSuccess swaps = 2;
 * @return {!Array.<!proto.xudrpc.SwapSuccess>}
 */
proto.xudrpc.ListOrderHistoryResponse.prototype.getSwapsList = function() {
...
proto.xudrpc.ListOrderHistoryResponse.prototype.setSwapsList = function(value) {
 ...
 */
proto.xudrpc.ListOrderHistoryResponse.prototype.addSwaps = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 2, opt_value, proto.xudrpc.SwapSuccess, opt_index);
};


proto.xudrpc.ListOrderHistoryResponse.prototype.clearSwapsList = function() {
  this.setSwapsList([]);
};
 ...
 * @return {!proto.xudrpc.ListOrderHistoryResponse.OrderStatus}
 */
proto.xudrpc.ListOrderHistoryResponse.prototype.getStatus = function() {
  return /** @type {!proto.xudrpc.ListOrderHistoryResponse.OrderStatus} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/** @param {!proto.xudrpc.ListOrderHistoryResponse.OrderStatus} value */
proto.xudrpc.ListOrderHistoryResponse.prototype.setStatus = function(value) {
  jspb.Message.setField(this, 3, value);
};
