...
goog.exportSymbol('proto.xudrpc.SwapDeal', null, global);
goog.exportSymbol('proto.xudrpc.SwapFailure', null, global);
goog.exportSymbol('proto.xudrpc.SwapRole', null, global);
...
proto.xudrpc.ListSwapsResponse.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    proto.xudrpc.SwapDeal.toObject, includeInstance)
  };
...
proto.xudrpc.ListSwapsResponse.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    ...
    switch (field) {
    case 1:
      var value = new proto.xudrpc.SwapDeal;
      reader.readMessage(value,proto.xudrpc.SwapDeal.deserializeBinaryFromReader);
      msg.addSwaps(value);
      break;
    default:
      reader.skipField();
...
proto.xudrpc.ListSwapsResponse.serializeBinaryToWriter = function(message, writer) {
  ...
  if (f.length > 0) {
    writer.writeRepeatedMessage(
      1,
      f,
      proto.xudrpc.SwapDeal.serializeBinaryToWriter
    );
  }
};
...
/**
 * repeated SwapDeal swaps = 1;
 * @return {!Array.<!proto.xudrpc.SwapDeal>}
 */
proto.xudrpc.ListSwapsResponse.prototype.getSwapsList = function() {
  return /** @type{!Array.<!proto.xudrpc.SwapDeal>} */ (
    jspb.Message.getRepeatedWrapperField(this, proto.xudrpc.SwapDeal, 1));
};


/** @param {!Array.<!proto.xudrpc.SwapDeal>} value */
...
/**
 * @param {!proto.xudrpc.SwapDeal=} opt_value
 * @param {number=} opt_index
 * @return {!proto.xudrpc.SwapDeal}
 */
proto.xudrpc.ListSwapsResponse.prototype.addSwaps = function(opt_value, opt_index) {
  return jspb.Message.addToRepeatedWrapperField(this, 1, opt_value, proto.xudrpc.SwapDeal, opt_index);
};
 ...
 * @constructor
 */
proto.xudrpc.SwapDeal = function(opt_data) {
  jspb.Message.initialize(this, opt_data, 0, -1, null, null);
};
goog.inherits(proto.xudrpc.SwapDeal, jspb.Message);
if (goog.DEBUG && !COMPILED) {
  proto.xudrpc.SwapDeal.displayName = 'proto.xudrpc.SwapDeal';
}
 ...
 * @return {!Object}
 */
proto.xudrpc.SwapDeal.prototype.toObject = function(opt_includeInstance) {
  return proto.xudrpc.SwapDeal.toObject(opt_includeInstance, this);
};
 ...
 *     instance for transitional soy proto support:
 *     http://goto/soy-param-migration
 * @param {!proto.xudrpc.SwapDeal} msg The msg instance to transform.
 * @return {!Object}
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.xudrpc.SwapDeal.toObject = function(includeInstance, msg) {
  var f, obj = {
    ...
    amountReceived: jspb.Message.getFieldWithDefault(msg, 4, 0),
    currencyReceived: jspb.Message.getFieldWithDefault(msg, 5, ""),
    currencySent: jspb.Message.getFieldWithDefault(msg, 6, ""),
 ...
 * @return {!proto.xudrpc.SwapDeal}
 */
proto.xudrpc.SwapDeal.deserializeBinary = function(bytes) {
  var reader = new jspb.BinaryReader(bytes);
  var msg = new proto.xudrpc.SwapDeal;
  return proto.xudrpc.SwapDeal.deserializeBinaryFromReader(msg, reader);
};
 ...
 * Deserializes binary data (in protobuf wire format) from the
 * given reader into the given message object.
 * @param {!proto.xudrpc.SwapDeal} msg The message object to deserialize into.
 * @param {!jspb.BinaryReader} reader The BinaryReader to use.
 * @return {!proto.xudrpc.SwapDeal}
 */
proto.xudrpc.SwapDeal.deserializeBinaryFromReader = function(msg, reader) {
  while (reader.nextField()) {
    if (reader.isEndGroup()) {
      break;
    }
    ...
    case 6:
      ...
      break;
    case 7:
      var value = /** @type {!proto.xudrpc.SwapRole} */ (reader.readEnum());
      msg.setRole(value);
      break;
    case 8:
      var value = /** @type {string} */ (reader.readString());
 ...
 * @return {!Uint8Array}
 */
proto.xudrpc.SwapDeal.prototype.serializeBinary = function() {
  var writer = new jspb.BinaryWriter();
  proto.xudrpc.SwapDeal.serializeBinaryToWriter(this, writer);
  return writer.getResultBuffer();
};
 ...
 * Serializes the given message to binary data (in protobuf wire
 * format), writing to the given BinaryWriter.
 * @param {!proto.xudrpc.SwapDeal} message
 * @param {!jspb.BinaryWriter} writer
 * @suppress {unusedLocalVariables} f is only used for nested messages
 */
proto.xudrpc.SwapDeal.serializeBinaryToWriter = function(message, writer) {
  var f = undefined;
  f = message.getPeerPubKey();
  if (f.length > 0) {
    writer.writeString(
 ...
 * @return {string}
 */
proto.xudrpc.SwapDeal.prototype.getPeerPubKey = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 1, ""));
};


/** @param {string} value */
proto.xudrpc.SwapDeal.prototype.setPeerPubKey = function(value) {
  jspb.Message.setField(this, 1, value);
};
 ...
 * @return {string}
 */
proto.xudrpc.SwapDeal.prototype.getLocalId = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 2, ""));
};


/** @param {string} value */
proto.xudrpc.SwapDeal.prototype.setLocalId = function(value) {
  jspb.Message.setField(this, 2, value);
};
 ...
 * @return {number}
 */
proto.xudrpc.SwapDeal.prototype.getAmountSent = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 3, 0));
};


/** @param {number} value */
proto.xudrpc.SwapDeal.prototype.setAmountSent = function(value) {
  jspb.Message.setField(this, 3, value);
};


/**
 * optional uint64 amount_received = 4;
 * @return {number}
 */
proto.xudrpc.SwapDeal.prototype.getAmountReceived = function() {
  return /** @type {number} */ (jspb.Message.getFieldWithDefault(this, 4, 0));
};


/** @param {number} value */
proto.xudrpc.SwapDeal.prototype.setAmountReceived = function(value) {
  jspb.Message.setField(this, 4, value);
};


/**
 * optional string currency_received = 5;
 * @return {string}
 */
proto.xudrpc.SwapDeal.prototype.getCurrencyReceived = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 5, ""));
};


/** @param {string} value */
proto.xudrpc.SwapDeal.prototype.setCurrencyReceived = function(value) {
  jspb.Message.setField(this, 5, value);
};


/**
 * optional string currency_sent = 6;
 * @return {string}
 */
proto.xudrpc.SwapDeal.prototype.getCurrencySent = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 6, ""));
};


/** @param {string} value */
proto.xudrpc.SwapDeal.prototype.setCurrencySent = function(value) {
  jspb.Message.setField(this, 6, value);
};


/**
 * optional SwapRole role = 7;
 * @return {!proto.xudrpc.SwapRole}
 */
proto.xudrpc.SwapDeal.prototype.getRole = function() {
  return /** @type {!proto.xudrpc.SwapRole} */ (jspb.Message.getFieldWithDefault(this, 7, 0));
};


/** @param {!proto.xudrpc.SwapRole} value */
proto.xudrpc.SwapDeal.prototype.setRole = function(value) {
  jspb.Message.setField(this, 7, value);
};


/**
 * optional string r_hash = 8;
 * @return {string}
 */
proto.xudrpc.SwapDeal.prototype.getRHash = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 8, ""));
};


/** @param {string} value */
proto.xudrpc.SwapDeal.prototype.setRHash = function(value) {
 ...
 * @return {string}
 */
proto.xudrpc.SwapDeal.prototype.getFailureReason = function() {
  return /** @type {string} */ (jspb.Message.getFieldWithDefault(this, 9, ""));
};


/** @param {string} value */
proto.xudrpc.SwapDeal.prototype.setFailureReason = function(value) {
  jspb.Message.setField(this, 9, value);
};
...
/**
 * optional SwapRole role = 11;
 * @return {!proto.xudrpc.SwapRole}
 */
proto.xudrpc.SwapSuccess.prototype.getRole = function() {
  return /** @type {!proto.xudrpc.SwapRole} */ (jspb.Message.getFieldWithDefault(this, 11, 0));
};
