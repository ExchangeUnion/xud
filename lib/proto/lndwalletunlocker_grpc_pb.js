...
'use strict';
var lndwalletunlocker_pb = require('./lndwalletunlocker_pb.js');
var lndrpc_pb = require('./lndrpc_pb.js');

function serialize_lnrpc_ChangePasswordRequest(arg) {
  if (!(arg instanceof lndwalletunlocker_pb.ChangePasswordRequest)) {
...
function deserialize_lnrpc_ChangePasswordRequest(buffer_arg) {
  return lndwalletunlocker_pb.ChangePasswordRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_lnrpc_ChangePasswordResponse(arg) {
  if (!(arg instanceof lndwalletunlocker_pb.ChangePasswordResponse)) {
...
function deserialize_lnrpc_ChangePasswordResponse(buffer_arg) {
  return lndwalletunlocker_pb.ChangePasswordResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_lnrpc_GenSeedRequest(arg) {
  if (!(arg instanceof lndwalletunlocker_pb.GenSeedRequest)) {
...
function deserialize_lnrpc_GenSeedRequest(buffer_arg) {
  return lndwalletunlocker_pb.GenSeedRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_lnrpc_GenSeedResponse(arg) {
  if (!(arg instanceof lndwalletunlocker_pb.GenSeedResponse)) {
...
function deserialize_lnrpc_GenSeedResponse(buffer_arg) {
  return lndwalletunlocker_pb.GenSeedResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_lnrpc_InitWalletRequest(arg) {
  if (!(arg instanceof lndwalletunlocker_pb.InitWalletRequest)) {
...
function deserialize_lnrpc_InitWalletRequest(buffer_arg) {
  return lndwalletunlocker_pb.InitWalletRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_lnrpc_InitWalletResponse(arg) {
  if (!(arg instanceof lndwalletunlocker_pb.InitWalletResponse)) {
...
function deserialize_lnrpc_InitWalletResponse(buffer_arg) {
  return lndwalletunlocker_pb.InitWalletResponse.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_lnrpc_UnlockWalletRequest(arg) {
  if (!(arg instanceof lndwalletunlocker_pb.UnlockWalletRequest)) {
...
function deserialize_lnrpc_UnlockWalletRequest(buffer_arg) {
  return lndwalletunlocker_pb.UnlockWalletRequest.deserializeBinary(new Uint8Array(buffer_arg));
}

function serialize_lnrpc_UnlockWalletResponse(arg) {
  if (!(arg instanceof lndwalletunlocker_pb.UnlockWalletResponse)) {
...
function deserialize_lnrpc_UnlockWalletResponse(buffer_arg) {
  return lndwalletunlocker_pb.UnlockWalletResponse.deserializeBinary(new Uint8Array(buffer_arg));
}
