...
export const builder = (argv: Argv) =>
  argv
    ...
    .example(
      '$0 withdraw 0.1 BTC 1BitcoinEaterAddressDontSendf59kuE',
      'withdraws 0.1 BTC'
    )
    .example(
      '$0 withdraw 0.1 BTC 1BitcoinEaterAddressDontSendf59kuE 20',
      'withdraws 0.1 BTC using 20 sats/byte'
    )
    .example(
      '$0 withdraw --all --currency BTC --address 1BitcoinEaterAddressDontSendf59kuE',
      'withdraws all BTC'
    );
