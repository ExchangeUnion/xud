# [1.0.0-beta](https://github.com/ExchangeUnion/xud/compare/v1.0.0-testnet.1...v1.0.0-beta) (2020-01-16)
...
* **cli:** executeswap don't set undefined quantity ([8e61343](https://github.com/ExchangeUnion/xud/commit/8e61343a9ceecf7eac0ac9ffc885f8cd45d0f708)), closes [#1175](https://github.com/ExchangeUnion/xud/issues/1175)
* **cli:** naming inconsistencies ([#1203](https://github.com/ExchangeUnion/xud/issues/1203)) ([f94c7f3](https://github.com/ExchangeUnion/xud/commit/f94c7f34fbb2263fe78f1de417a6c023588d8d6f))
...
* **lnd:** wait for macaroon before wallet created ([6ae653d](https://github.com/ExchangeUnion/xud/commit/6ae653d69d2e7add10a6686601a4c8b33753ba9e))
* **lnd:** waitForReady infinite deadline ([#1152](https://github.com/ExchangeUnion/xud/issues/1152)) ([86d2b20](https://github.com/ExchangeUnion/xud/commit/86d2b20e01ec3ab5074c7428d1b517a923204c59))
...
* **p2p:** prevent xud from crashing when connecting to peer timeouts ([7932b51](https://github.com/ExchangeUnion/xud/commit/7932b517430b37eb9b93d7a22c1d6d286e6b32d6))
...
* **peer:** logging label/node pub key ([dec2a46](https://github.com/ExchangeUnion/xud/commit/dec2a46315aa438597390141a0c29138131f63dc))
* **pool:** xud crashes upon receiving NodeStateUpdatePacket including an unexisting trading pair ([693a01b](https://github.com/ExchangeUnion/xud/commit/693a01bcd97e6045121ec4d01b982ca70f053356))
* **raiden:** log new address correctly ([0e8fa0d](https://github.com/ExchangeUnion/xud/commit/0e8fa0d224ad1caaf57c4bfc21330120fe9a60de))
...
* **seedutil:** avoid logging seed in logs ([6fdc36b](https://github.com/ExchangeUnion/xud/commit/6fdc36b092f979e178536cf5c66edce5b049fb44))
* **swapclientmanager:** catch genseed errors ([d5b0fed](https://github.com/ExchangeUnion/xud/commit/d5b0fed20647c655db6027a62c8e27d1f1c7dacf))
* **swaps:** add resolve request validation slippage ([99600c4](https://github.com/ExchangeUnion/xud/commit/99600c4fc05c51275a42b838d968f6d847e8e1dc))
* **swaps:** check payment rejected error code ([5682a0a](https://github.com/ExchangeUnion/xud/commit/5682a0accdf80bc55c8070eda7b61da98d433277))
* **swaps:** validate Raiden's resolve request ([6d525a7](https://github.com/ExchangeUnion/xud/commit/6d525a7ec47e4c7dbd66e86dc87c63e2ec890318))
...
* allow graceful shutdown while awaiting unlock ([3821ffd](https://github.com/ExchangeUnion/xud/commit/3821ffd25a08c7bc36dfe22c32c18fdbb3e962aa))
* change dai ropsten contract to kyber dai ropsten contract ([#1148](https://github.com/ExchangeUnion/xud/issues/1148)) ([9e81fcc](https://github.com/ExchangeUnion/xud/commit/9e81fccec3dde27fc6ae92668ac636b156289fd8))
* change testnet seed node key, add mainnet seed node key ([#1193](https://github.com/ExchangeUnion/xud/issues/1193)) ([809c5d8](https://github.com/ExchangeUnion/xud/commit/809c5d80e9dbbf807635df36584a1718dc6e3c35))
* don't allow new connections while pool closes ([173303b](https://github.com/ExchangeUnion/xud/commit/173303b36a90c26b8e4f6c8743b362ceb5bf8d2e))
* log error message reason correctly ([#1209](https://github.com/ExchangeUnion/xud/issues/1209)) ([69962db](https://github.com/ExchangeUnion/xud/commit/69962db97e4dee3c8823ab11273bb8733e94c48c))
* README link adjustment wiki -> docs.exchangeunion.com ([9a03442](https://github.com/ExchangeUnion/xud/commit/9a03442c5f40f9c6ccd6f248c8fbe7291b62df00))
* reconnect log message ([#1260](https://github.com/ExchangeUnion/xud/issues/1260)) ([8034c6c](https://github.com/ExchangeUnion/xud/commit/8034c6cfa88a20804a78dde61c45e339eb2a8f93))
...
* **seedutil:** separate aezeed & encryption pwords ([977e3d9](https://github.com/ExchangeUnion/xud/commit/977e3d9b9b04d2f5b263a47827e80ebb91b8259b))
* **swapclient:** continue reconnection attempts ([a1a2586](https://github.com/ExchangeUnion/xud/commit/a1a2586086241a9ac7ec97550263da5aca64d148)), closes [#1240](https://github.com/ExchangeUnion/xud/issues/1240)
* **swaps:** calc lock duration hours correctly ([73c43f6](https://github.com/ExchangeUnion/xud/commit/73c43f6bb020bfa00286e061717c7bf098e24c8e)), closes [#1205](https://github.com/ExchangeUnion/xud/issues/1205)
* **swaps:** prevent crash on send payment failure ([555349e](https://github.com/ExchangeUnion/xud/commit/555349e1abce14bb33fafbb8ca27551f65f3c1f0)), closes [#1155](https://github.com/ExchangeUnion/xud/issues/1155)
* **swaps:** set cltvLimit correctly ([31b41a1](https://github.com/ExchangeUnion/xud/commit/31b41a10a8a20391739185d1a39743b726bf823b)), closes [#1158](https://github.com/ExchangeUnion/xud/issues/1158)
* update simnet token addresses ([#1150](https://github.com/ExchangeUnion/xud/issues/1150)) ([7737da8](https://github.com/ExchangeUnion/xud/commit/7737da85de7535e7be518968af9453415c896856))
...
* **cli:** enhance create output ([a3e94f1](https://github.com/ExchangeUnion/xud/commit/a3e94f163c751683f9954b897b715b7bec4e6d3d)), closes [#1210](https://github.com/ExchangeUnion/xud/issues/1210)
* **cli:** enhance listpeers output ([d093597](https://github.com/ExchangeUnion/xud/commit/d093597fb46407a2fa08e3cd34aada2860a85ae5))
* **cli:** getinfo enhancements ([#1170](https://github.com/ExchangeUnion/xud/issues/1170)) ([6c5dae5](https://github.com/ExchangeUnion/xud/commit/6c5dae5c0a28b019168a8aa516a15995581ecc5b)), closes [#1059](https://github.com/ExchangeUnion/xud/issues/1059)
* **cli:** hide password input ([dd6e8d9](https://github.com/ExchangeUnion/xud/commit/dd6e8d908a9a745faff42d16d897c3072e81b955))
* **cli:** improve create call response wording ([#1246](https://github.com/ExchangeUnion/xud/issues/1246)) ([f32fe6d](https://github.com/ExchangeUnion/xud/commit/f32fe6d9e23305bb2bce0b7b692584b851e1ac70))
* **cli:** output enhancements ([f234be1](https://github.com/ExchangeUnion/xud/commit/f234be1d947cd5c19c55463fe77a42b7530486e9))
* **cli:** set exit code 1 on errored calls ([ff9aefd](https://github.com/ExchangeUnion/xud/commit/ff9aefd1651f7764b10688f9cfe2f46c842fee2a))
* **cli:** wait for client on create/unlock ([a6b1d97](https://github.com/ExchangeUnion/xud/commit/a6b1d9752bb7764c29a41896d2a015028f076f96))
* **cli:** wait for tls cert on create ([0ceca00](https://github.com/ExchangeUnion/xud/commit/0ceca007498942f0d638a36f5a998e2b8a88f204))
...
* **config:** default p2p port based on network ([bc51422](https://github.com/ExchangeUnion/xud/commit/bc51422130d46b3b0cfcec1903cce2ba2dc8690e)), closes [#1238](https://github.com/ExchangeUnion/xud/issues/1238)
* **config:** exit on invalid config file ([356c2c7](https://github.com/ExchangeUnion/xud/commit/356c2c7453805803b7009b53a2fac8895bec51a2))
* **db:** add simnet default currencies and pairs ([29d6479](https://github.com/ExchangeUnion/xud/commit/29d647958615d8253c4340fb3e114dd6604021e4))
...
* **grpc:** log call response errors ([9913bda](https://github.com/ExchangeUnion/xud/commit/9913bdab6f8e4c6fa1ac8b64f2db13500ba9da50))
* **initservice:** return list of wallets ([15ec140](https://github.com/ExchangeUnion/xud/commit/15ec140d4dbf3ed168881f903c8d993e7b175e22)), closes [#1018](https://github.com/ExchangeUnion/xud/issues/1018)
* **lnd:** automatically unlock wallet on restart ([457cb67](https://github.com/ExchangeUnion/xud/commit/457cb672437ca0d3fb2ceb43dde6a230e7bde9cc)), closes [#1196](https://github.com/ExchangeUnion/xud/issues/1196)
* **lnd:** update to v0.7.1-beta ([#1141](https://github.com/ExchangeUnion/xud/issues/1141)) ([e73ec4b](https://github.com/ExchangeUnion/xud/commit/e73ec4bee3fef715d0ea26bc2ca0ffc379d9f5e0))
* **lnd:** wait for tls.cert ([6398cd5](https://github.com/ExchangeUnion/xud/commit/6398cd5fee2abb843d403321f039e70c2594fd28))
* **orderbook:** check for swap clients before add ([72335a0](https://github.com/ExchangeUnion/xud/commit/72335a07e6230443c3c9ba8014bf55f329248de5)), closes [#983](https://github.com/ExchangeUnion/xud/issues/983)
...
* **p2p:** log peer's expectedpubkey ([527a88d](https://github.com/ExchangeUnion/xud/commit/527a88d156ca1005333d1f7c9916b8eaed3588c0))
* **peer:** log pubkey on retry connect ([#1144](https://github.com/ExchangeUnion/xud/issues/1144)) ([97c0d1a](https://github.com/ExchangeUnion/xud/commit/97c0d1aa3f6ab5f8d11e37a07ef32fe7dfc20acc))
...
* **rpc:** ListCurrencies enhancement ([3d716b6](https://github.com/ExchangeUnion/xud/commit/3d716b66caca66b3bb82c91d04d3c7a3948f9358)), closes [#1067](https://github.com/ExchangeUnion/xud/issues/1067)
...
* **rpc:** ListTrades command ([740b174](https://github.com/ExchangeUnion/xud/commit/740b1747e61d68fef691fac7a59d815a39e8ecba)), closes [#667](https://github.com/ExchangeUnion/xud/issues/667)
...
* **swap:** persist active swap deals to db ([1a0692b](https://github.com/ExchangeUnion/xud/commit/1a0692b86f2e658b5522d01b8631947368fc84c7)), closes [#1079](https://github.com/ExchangeUnion/xud/issues/1079)
* **swapclient:** add timeout to initialization ([5c0f04e](https://github.com/ExchangeUnion/xud/commit/5c0f04e98f67e05d8e00182f710b899a74b805fa))
* **swapclient:** heartbeat ([f427158](https://github.com/ExchangeUnion/xud/commit/f427158053cf885635a46e2473147124b7aff9a4)), closes [#1090](https://github.com/ExchangeUnion/xud/issues/1090)
* **swapclient:** update capacity on channelbalance ([3f43e66](https://github.com/ExchangeUnion/xud/commit/3f43e6659efb7dbb0c20c60ddaa40c966b86270c))
* **swaps:** dynamic lock buffer ([cf83ab0](https://github.com/ExchangeUnion/xud/commit/cf83ab07e13f1e96bd313438ea8a08f0364dd3c1)), closes [#1164](https://github.com/ExchangeUnion/xud/issues/1164)
* **swaps:** improved remote error handling ([5e21166](https://github.com/ExchangeUnion/xud/commit/5e21166d1171b45e5aad3db33f44c584dd1090b3))
* **swaps:** logging improvements ([f2815d2](https://github.com/ExchangeUnion/xud/commit/f2815d2f7584a721c063db421a446f5c7ec8eec0)), closes [#1157](https://github.com/ExchangeUnion/xud/issues/1157)
* **swaps:** raiden claims recovered swap payments ([719e199](https://github.com/ExchangeUnion/xud/commit/719e1992d89482145158a5f74f0a9d7e7ac37eb0)), closes [#1251](https://github.com/ExchangeUnion/xud/issues/1251)
* **swaps:** recover crashed swap deals ([856f14a](https://github.com/ExchangeUnion/xud/commit/856f14a29ab100805906fd7034ed3c6b93fb481e)), closes [#1079](https://github.com/ExchangeUnion/xud/issues/1079)
...
* $10 mainnet order size limits ([c6c74eb](https://github.com/ExchangeUnion/xud/commit/c6c74ebcc9057a7d5792a306772748ff4c2913de)), closes [#1230](https://github.com/ExchangeUnion/xud/issues/1230)
* create eth keystore with master seed ([9b4d9f9](https://github.com/ExchangeUnion/xud/commit/9b4d9f93d492bd63e84c7ddb7be5efcdd0748bfe)), closes [#1242](https://github.com/ExchangeUnion/xud/issues/1242)
* limit trade & order sizes for mainnet ([f161d19](https://github.com/ExchangeUnion/xud/commit/f161d19cccfcc679f60fa9a22eb700b1bc24a5bf)), closes [#948](https://github.com/ExchangeUnion/xud/issues/948)
* not connecting to its own addresses ([27547af](https://github.com/ExchangeUnion/xud/commit/27547afefae7d1bbed98670de357110ccf77aa10))
* seed ports adjustment ([3b2cd3c](https://github.com/ExchangeUnion/xud/commit/3b2cd3ccb01a815745017dc2d3f6b660845dbcea))
* show git commit hash in version ([#1200](https://github.com/ExchangeUnion/xud/issues/1200)) ([876335e](https://github.com/ExchangeUnion/xud/commit/876335e97b1655762556fa34986016200c4cee72))
* shutdown gracefully on SIGTERM ([847a251](https://github.com/ExchangeUnion/xud/commit/847a251074bad9b54a0cc2414b84308e23911b25))
* shutdown xud on error during init ([9822d77](https://github.com/ExchangeUnion/xud/commit/9822d7700e4f963e2cc839b318f395d4cc0ca4d0))
* wait for lnd on create call ([a74780c](https://github.com/ExchangeUnion/xud/commit/a74780c4997ae1bdb8004a827858c061d08f5886)), closes [#1252](https://github.com/ExchangeUnion/xud/issues/1252)
