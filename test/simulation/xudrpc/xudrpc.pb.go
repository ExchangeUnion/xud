...
type SwapClient int32

const (
	SwapClient_LND     SwapClient = 0
	SwapClient_CONNEXT SwapClient = 2
)

var SwapClient_name = map[int32]string{
	0: "LND",
	2: "CONNEXT",
}

var SwapClient_value = map[string]int32{
	"LND":     0,
	"CONNEXT": 2,
}

func (x SwapClient) String() string {
	return proto.EnumName(SwapClient_name, int32(x))
}

func (SwapClient) EnumDescriptor() ([]byte, []int) {
...
type Currency struct {
	...
	SwapClient SwapClient `protobuf:"varint,2,opt,name=swap_client,proto3,enum=xudrpc.SwapClient" json:"swap_client,omitempty"`
...
func (m *Currency) GetSwapClient() SwapClient {
	if m != nil {
		return m.SwapClient
	}
	return SwapClient_LND
}
...
type InitSwapClientRequest struct {
	// The swap client to initialize.
	SwapClient SwapClient `protobuf:"varint,1,opt,name=swap_client,proto3,enum=xudrpc.SwapClient" json:"swap_client,omitempty"`
	// The ticker symbol of the currency the swap client is for, if applicable.
	Currency             string   `protobuf:"bytes,2,opt,name=currency,proto3" json:"currency,omitempty"`
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
...
func (m *InitSwapClientRequest) Reset()         { *m = InitSwapClientRequest{} }
func (m *InitSwapClientRequest) String() string { return proto.CompactTextString(m) }
func (*InitSwapClientRequest) ProtoMessage()    {}
func (*InitSwapClientRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_6960a02cc0a63cf6, []int{26}
}

func (m *InitSwapClientRequest) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_InitSwapClientRequest.Unmarshal(m, b)
}
func (m *InitSwapClientRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_InitSwapClientRequest.Marshal(b, m, deterministic)
}
func (m *InitSwapClientRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_InitSwapClientRequest.Merge(m, src)
}
func (m *InitSwapClientRequest) XXX_Size() int {
	return xxx_messageInfo_InitSwapClientRequest.Size(m)
}
func (m *InitSwapClientRequest) XXX_DiscardUnknown() {
	xxx_messageInfo_InitSwapClientRequest.DiscardUnknown(m)
}

var xxx_messageInfo_InitSwapClientRequest proto.InternalMessageInfo

func (m *InitSwapClientRequest) GetSwapClient() SwapClient {
	if m != nil {
		return m.SwapClient
	}
	return SwapClient_LND
...
func (m *InitSwapClientRequest) GetCurrency() string {
	if m != nil {
		return m.Currency
	}
	return ""
...
type InitSwapClientResponse struct {
	XXX_NoUnkeyedLiteral struct{} `json:"-"`
	XXX_unrecognized     []byte   `json:"-"`
	XXX_sizecache        int32    `json:"-"`
}

func (m *InitSwapClientResponse) Reset()         { *m = InitSwapClientResponse{} }
func (m *InitSwapClientResponse) String() string { return proto.CompactTextString(m) }
func (*InitSwapClientResponse) ProtoMessage()    {}
func (*InitSwapClientResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_6960a02cc0a63cf6, []int{27}
}

func (m *InitSwapClientResponse) XXX_Unmarshal(b []byte) error {
	return xxx_messageInfo_InitSwapClientResponse.Unmarshal(m, b)
}
func (m *InitSwapClientResponse) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	return xxx_messageInfo_InitSwapClientResponse.Marshal(b, m, deterministic)
}
func (m *InitSwapClientResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_InitSwapClientResponse.Merge(m, src)
}
func (m *InitSwapClientResponse) XXX_Size() int {
	return xxx_messageInfo_InitSwapClientResponse.Size(m)
}
func (m *InitSwapClientResponse) XXX_DiscardUnknown() {
	xxx_messageInfo_InitSwapClientResponse.DiscardUnknown(m)
}

var xxx_messageInfo_InitSwapClientResponse proto.InternalMessageInfo
...
func init() {
	...
	proto.RegisterEnum("xudrpc.SwapClient", SwapClient_name, SwapClient_value)
	...
	proto.RegisterType((*InitSwapClientRequest)(nil), "xudrpc.InitSwapClientRequest")
	proto.RegisterType((*InitSwapClientResponse)(nil), "xudrpc.InitSwapClientResponse")
...
var fileDescriptor_6960a02cc0a63cf6 = []byte{
	...
	,
}
...
type XudClient interface {
	...
	InitSwapClient(ctx context.Context, in *InitSwapClientRequest, opts ...grpc.CallOption) (*InitSwapClientResponse, error)
...
func (c *xudClient) InitSwapClient(ctx context.Context, in *InitSwapClientRequest, opts ...grpc.CallOption) (*InitSwapClientResponse, error) {
	out := new(InitSwapClientResponse)
	err := c.cc.Invoke(ctx, "/xudrpc.Xud/InitSwapClient", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type XudServer interface {
	...
	// password to seed and encrypt its wallet & addresses.
	// shell: xucli initclient <swap_client> [currency]
	InitSwapClient(context.Context, *InitSwapClientRequest) (*InitSwapClientResponse, error)
	// Gets orders from the order book. This call returns the state of the order book at a given point
	// in time, although it is not guaranteed to still be vaild by the time a response is received
	// and processed by a client. It accepts an optional trading pair id parameter. If specified, only
	// orders for that particular trading pair are returned. Otherwise, all orders are returned. Orders
...
func _Xud_InitSwapClient_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(InitSwapClientRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(XudServer).InitSwapClient(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/xudrpc.Xud/InitSwapClient",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(XudServer).InitSwapClient(ctx, req.(*InitSwapClientRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Xud_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "InitSwapClient",
			Handler:    _Xud_InitSwapClient_Handler,
		},
		{
